import { Shirt, Gem, Scissors, Ruler, Users, Flower2 } from "lucide-react";
...
const services = [
  ...
  // {
  //   icon: Flower2,
  //   title: "Saree Blouse Design",
  //   description: "Beautifully designed saree blouses with intricate detailing, perfect for any occasion.",
  // },
];
